...
public class KhachHangController {
    ...
    private void handleEditCustomer() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/bookstore/view/KhachHangEditView.fxml"));
            Parent root = loader.load();
            KhachHangEditController editController = loader.getController();
