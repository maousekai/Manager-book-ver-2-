...
public class DashboardController {
    ...
    private void initialize() {
        ...
        // PHÂN QUYỀN MENU DỰA TRÊN ROLE Nhân Viên
        ...
        if (userRole == 1) { // 1 = MANAGER/ADMIN
            navItems = FXCollections.observableArrayList(
                "Trang chủ", "Bán hàng", "Quản lý Sản phẩm", "Quản lý Nhân viên",
                "Quản lý Khách hàng", "Quản lý Hoá đơn", "Hoá đơn Nhập kho", "Báo cáo"
            );
        } else { // 2 = STAFF
            navItems = FXCollections.observableArrayList(
                "Trang chủ", "Bán hàng", "Quản lý Sản phẩm", "Quản lý Khách hàng"
            );
        }
    ...
    public void loadView(String viewName) {
        ...
        try {
            switch (viewName) {
                case "Trang chủ":
                    fxmlFile = "/com/bookstore/view/HomeView.fxml";
                    break;
                case "Bán hàng":
                    fxmlFile = "/com/bookstore/view/SaleView.fxml";
                    break;
                case "Quản lý Sản phẩm":
                    fxmlFile = "/com/bookstore/view/ProductView.fxml";
                    break;
                case "Quản lý Hoá đơn":
                    fxmlFile = "/com/bookstore/view/InvoiceView.fxml";
                    break;
                case "Hoá đơn Nhập kho":
                    fxmlFile = "/com/bookstore/view/ImportInvoiceView.fxml";
                    break;
                case "Quản lý Nhân viên":
                    fxmlFile = "/com/bookstore/view/EmployeeView.fxml";
                    break;
                case "Quản lý Khách hàng":
                    fxmlFile = "/com/bookstore/view/CustomerView.fxml";
                    break;
                case "Báo cáo":
                    fxmlFile = "/com/bookstore/view/ReportView.fxml";
                    break;
                default:
                    fxmlFile = null;
                    break; 
    ...
    private void handleLogout() {
        ...
        StageManager.switchScene(
            "/com/bookstore/view/LoginView.fxml", 
            "Đăng nhập hệ thống"
        );
    }
